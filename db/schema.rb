...
ActiveRecord::Schema.define(version: 2023_04_15_054802) do
  ...
  create_table "added_channels", force: :cascade do |t|
    t.text "name"
  ...
  create_table "added_subreddits", force: :cascade do |t|
  ...
  create_table "user_configurations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "youtube_channel_refresh_limit", default: 5, null: false
    t.datetime "youtube_refresh_date"
  end
